...
from ingest_pipeline.assets.polygon import extract_load_polygon_stocks
import yaml
import time
import asyncio
...
def pipeline(config: dict, pipeline_logging: PipelineLogging):
    ...
    KAFKA_TOPIC_NAME = os.environ.get("kafka_stocks_topic_name")
